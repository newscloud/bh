...
class ProfileUrl extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, twitter_id, url, created_at, modified_at', 'safe', 'on'=>'search'),
		);
	}
	...
	public function add($twitter_id,$url='') {
    $u = Url::model()->findByAttributes(array('twitter_id'=>$twitter_id,'url'=>$url));
    if (empty($u)) {
  	  $u = new ProfileUrl;
