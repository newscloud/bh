...
<?php $this->widget('bootstrap.widgets.TbGridView',array(
    ...
    'htmlOptions'=>array('width'=>'100px'),  		
  	'class'=>'bootstrap.widgets.TbButtonColumn',
  	'header'=>'Options',
    'template'=>'{connect} {update}&nbsp;&nbsp;{delete}',
        'buttons'=>array
        (
            'connect' => array
            (
            ...
            'options'=>array('title'=>'update properties'),
              'label'=>'<i class="icon-twitter icon-large" style="margin:5px;"></i>',
              'url'=>'Yii::app()->createUrl("account/update", array("id"=>$data->id))',
            ),        
            'delete' => array
            (
            'options'=>array('title'=>'trash'),
              'label'=>'<i class="icon-trash icon-large" style="margin:5px;"></i>',
              'url'=>'Yii::app()->createUrl("account/delete", array("id"=>$data->id))',
            ),
        ),			
  ),
	),
