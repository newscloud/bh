...
class m140915_201607_create_profile_url_table extends CDbMigration
{
   ...
   public function before() {
    ...
    $this->createTable($this->tableName, array(
      ...
      $this->createIndex('profile_user_id', $this->tableName , 'twitter_id', false);               
      $this->addForeignKey('fk_profile_url_user_id', $this->tableName, 'twitter_id', $this->tablePrefix.'twitter_user', 'twitter_id', 'CASCADE', 'CASCADE');               
 	}
