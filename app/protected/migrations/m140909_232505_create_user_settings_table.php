...
class m140909_232505_create_user_settings_table extends CDbMigration
{
  ...
  $this->createTable($this->tableName, array(
             ...
             'klout_key'=>'string not null',
             'klout_secret'=>'string not null',
             'pocket_consumer_key'=>'string not null',
             'pocket_access_token'=>'string not null',
